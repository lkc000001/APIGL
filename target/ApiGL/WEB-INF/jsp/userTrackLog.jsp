...
<html lang="zh-Hant-TW">
	<head>
	    ...
	    <title>台灣企銀-日誌查詢系統使用者軌跡查詢</title>
	...
	<body class="sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed sidebar-collapseX" style="height: auto;">
		    ...
		    <div class="content-wrapper">
		        <div class="main-content">
		            <div class="main-title">
		                <span class="title-text" id="showtitle">使用者軌跡查詢</span>
		            </div>
		...
		<script>
			...
			document.getElementById("queryTable").value = 'UserTrackLog';
			document.getElementById("selectUserTrackLog").innerHTML = '<i class="fa-solid fa-circle nav-icon"></i>';
			document.getElementById("showtitle").innerHTML = document.getElementById("showUserTrackLog").innerHTML + "查詢";
			...
			function doquery() {
				...
				clicknum = 0;
				$("#jsGrid").jsGrid("reset");
				dojsGrid('queryUserTrackLog', showcount);
			}
				    ...
				    controller:
						{
						    loadData: function(filter) {
						    	if(checkClear != 1){
							        ...
							        return queryajax("/userTrackLog/" + apiurl, requ, "<%=request.getContextPath()%>");
						    	}
						    }
						},
						fields: [
							{ name: "userTrackId", type: "text", width: 40 , title:"索引" },
							{ name: "userTrackAccountID", type: "text", width: 100, title:"員工編號" },
							{ name: "userTrackAccount", type: "text", width: 100, title:"帳號"},
							{ name: "userTrackName", type: "text", width: 100, title:"姓名"},
							{ name: "userTrackUrl", type: "text", width: 200, title:"查詢表單"},
							...
							{ 
								itemTemplate: function(_, item) {
					                return $("<button>").text("詳細")
					                	.on("click", function() {
					        				document.getElementById("queryId").value = item.userTrackId;
