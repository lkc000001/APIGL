...
<html lang="zh-Hant-TW">
	<head>
	    ...
	    <title>台灣企銀-日誌查詢系統RewardAPILog</title>
	...
	<body class="sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed sidebar-collapseX" style="height: auto;">
		    ...
		    <div class="content-wrapper">
		        <div class="main-content">
		            <div class="main-title">
		                <span class="title-text" id="showtitle">RewardAPILog查詢</span>
		            </div>
		...
		<script>
			...
			var itemsCount = 0;
		    var checkClear = 0;
		    document.getElementById("queryTable").value = 'RewardApiLog';
		    document.getElementById("selectRewardApiLog").innerHTML = '<i class="fa-solid fa-circle nav-icon"></i>';
		    document.getElementById("showtitle").innerHTML = document.getElementById("showRewardApiLog").innerHTML + "日誌查詢";
			...
			function doquery() {
				...
				clicknum = 0;
				$("#jsGrid").jsGrid("reset");
				dojsGrid('queryRewardApiLog', showcount);
			}
				    ...
				    controller:
						{
						    loadData: function(filter) {
						    	if(checkClear != 1){
							        ...
							        return queryajax("/rewardApiLog/" + apiurl, requ, "<%=request.getContextPath()%>");
							    }
						    }
						},
						fields: [
							{ name: "rewardId", type: "text", width: 40 , title:"索引" },
							{ name: "rewardIdnTpan", type: "text", width: 140, title:"rewardIdnTpan" },
							{ name: "rewardSeqNo", type: "text", width: 100, title:"rewardSeqNo"},
							{ name: "rewardTxnTime", type: "text", width: 100, title:"rewardTxnTime"},
							...
							{ 
								itemTemplate: function(_, item) {
					                return $("<button>").text("詳細")
					                	.on("click", function() {
					        				document.getElementById("queryId").value = item.rewardId;
