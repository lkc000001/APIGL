...
<html lang="zh-Hant-TW">
	<head>
	    ...
	    <title>台灣企銀-日誌查詢系統HPG5000APILog</title>
	...
	<body class="sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed sidebar-collapseX sidebar-collapse" style="height: auto;">
		    ...
		    <div class="content-wrapper">
		        <div class="main-content">
		            <div class="main-title">
		                <span class="title-text" id="showtitle">HPG5000APILog查詢</span>
		            </div>
		...
		<script>
			...
			var itemsCount = 0;
		    var checkClear = 0;
		    document.getElementById("queryTable").value = 'Hpg5000ApiLog';
		    document.getElementById("selectHpg5000ApiLog").innerHTML = '<i class="fa-solid fa-circle nav-icon"></i>';
		    document.getElementById("showtitle").innerHTML = document.getElementById("showHpg5000ApiLog").innerHTML + "日誌查詢";
			...
			function doquery() {
				...
				clicknum = 0;
				$("#jsGrid").jsGrid("reset");
				dojsGrid('queryHpg5000ApiLog', showcount);
			}
				    ...
				    controller:
						{
						    loadData: function(filter) {
						    	if(checkClear != 1) {
							        ...
							        return queryajax("/hpg5000ApiLog/" + apiurl, requ, "<%=request.getContextPath()%>");
							    }
						    }
						},
						fields: [
							{ name: "hpgLogId", type: "text", width: 40 , title:"索引" },
							{ name: "hpgLogIdnTxn", type: "text", width: 120, title:"hpgLogIdnTxn" },
							{ name: "hpgLogSeqNo", type: "text", width: 160, title:"hpgLogSeqNo"},
							{ name: "hpgLogTxnTime", type: "text", width: 160, title:"hpgLogTxnTime"},
							...
							{ 
								itemTemplate: function(_, item) {
					                return $("<button>").text("詳細")
					                	.on("click", function() {
					        				document.getElementById("queryId").value = item.hpgLogId;
