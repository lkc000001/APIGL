...
<html lang="zh-Hant-TW">
	<head>
	    ...
	    <title>台灣企銀-日誌查詢系統SmsOtpLog</title>
	...
	<body class="sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed sidebar-collapseX" style="height: auto;">
		    ...
		    <div class="content-wrapper">
		        <div class="main-content">
		            <div class="main-title">
		                <span class="title-text" id="showtitle">SmsOtpLog查詢</span>
		            </div>
		...
		<script>
			...
			var itemsCount = 0;
		    var checkClear = 0;
		    document.getElementById("queryTable").value = 'SmsOtpLog';
		    document.getElementById("selectSmsOtpLog").innerHTML = '<i class="fa-solid fa-circle nav-icon"></i>';
		    document.getElementById("showtitle").innerHTML = document.getElementById("showSmsOtpLog").innerHTML + "日誌查詢";
			...
			function doquery() {
				...
				clicknum = 0;
				$("#jsGrid").jsGrid("reset");
				dojsGrid('querySmsOtpLog', showcount);
			}
				    ...
				    controller:
						{
						    loadData: function(filter) {
						    	if(checkClear != 1) {
							        ...
							        return queryajax("/smsOtpLog/" + apiurl, requ, "<%=request.getContextPath()%>");
							    }
						    }
						},
						fields: [
							{ name: "solId", type: "text", width: 40 , title:"索引" },
							{ name: "userId", type: "text", width: 140, title:"userId" },
							{ name: "phone", type: "text", width: 100, title:"phone"},
							{ name: "sysFlag", type: "text", width: 100, title:"sysFlag"},
							...
							{ 
								itemTemplate: function(_, item) {
					                return $("<button>").text("詳細")
					                	.on("click", function() {
					        				document.getElementById("queryId").value = item.solId;
